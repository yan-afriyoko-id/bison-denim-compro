...
const FALLBACK_SITE_SETTINGS = {
  ...
  company: {
    site_description: 'Bison Denim adalah perusahaan fashion Indonesia yang bergerak di bidang penjualan pakaian denim, kemeja, hoodie, dan berbagai produk fashion lainnya.',
    footer_description: 'Penyedia pakaian denim, kemeja, hoodie, dan produk fashion berkualitas untuk Indonesia.',
  },
  contact: {
...
export const FALLBACK_HOMEPAGE_SECTIONS: PageSection[] = [
  {
    ...
    section_type: 'intro',
    internal_name: 'Tentang Kami',
    content: {
      title: 'Tentang Kami',
      body: 'Bison Denim adalah perusahaan fashion Indonesia yang bergerak di bidang penjualan pakaian denim, kemeja, hoodie, dan berbagai produk fashion lainnya. Kami berkomitmen menghadirkan produk berkualitas dengan harga terjangkau untuk semua kalangan.\n\nDengan jaringan distribusi yang luas dan pengalaman lebih dari dua dekade, Bison Denim telah menjadi pilihan utama bagi konsumen yang mencari produk fashion denim dan non-denim yang terpercaya di Indonesia.',
