...
import { submitContactForm } from '@/actions/public-contact.actions';
...
export function ContactPageClient({ contactInfo }: ContactPageProps) {
              ...
              <div className="mt-6 border border-[#d4d4d4] overflow-hidden">
                <svg viewBox="0 0 400 200" className="block w-full h-[200px]" preserveAspectRatio="xMidYMid slice" role="img" aria-label={`Peta lokasi kantor ${contactInfo.siteName || 'kami'}`}>
                  ...
                  <g transform="translate(200 95)">
                    <path d="M0 0 C -12 -12 -12 -28 0 -28 C 12 -28 12 -12 0 0 Z" fill="#e63946" stroke="#ffffff" strokeWidth="2" />
